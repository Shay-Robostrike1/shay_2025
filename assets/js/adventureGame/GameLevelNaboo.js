...
class GameLevelNaboo {
  constructor(path) {
    ...
    // Background data
    const image_src_naboo = path + "/images/gamify/placeholder_desert.png"; // be sure to include the path
    const image_data_naboo = {
        name: 'naboo',
        greeting: "Welcome to Naboo! It is a beautiful and peaceful planet, but there are many adventures to be had!",
        src: image_src_naboo,
    ...
    const sprite_src_chillguy = path + "/images/gamify/placeholder_chillguy.png"; // be sure to include the path
    ...
    // NPC data for Tux 
    const sprite_src_tux = path + "/images/gamify/placeholder_tux.png"; // be sure to include the path
    const sprite_data_tux = {
      ...
      // const sprite_src_octocat = path + "/images/gamify/placeholder_octocat.png"; // be sure to include the path
    ...
    // const sprite_src_robot = path + "/images/gamify/placeholder_robot.png"; // be sure to include the path
...
const sprite_src_htmlhank = path + "/images/gamify/placeholder_htmlhank.png"; // be sure to include the path
const sprite_data_htmlhank = {
    ...
    this.objects = [
      { class: Background, data: image_data_naboo },
